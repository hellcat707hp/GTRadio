package com.sc.gtradio.automotive
 ...
 *
 */
class GTRadioAutomotiveMusicService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        session = MediaSessionCompat(this, "GTRadioAutomotiveMusicService")
